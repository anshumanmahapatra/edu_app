...
class AddComment extends StatefulWidget {
  final String doubtId, senderUserId;

  AddComment({@required this.doubtId, @required this.senderUserId});
                          ...
                          child: Column(
                            children: [
                              ListTile(
                                ...
                                trailing: snapshot.data.docs[index]['senderUserId'] ==
